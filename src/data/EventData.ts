...
const event_data: DataType[] = [
   ...
   },
   {
      ...
      city: "melbourne City",
      desc:
      "Celebrate childhood joy at our Happy Child Event! Join us for a day filled with laughter, games, and meaningful connections."
    },
   {
      id: 5,
      page:"inner_page",
      ...
      city: "melbourne City",
      desc:
      "Dive into our big project for water! Join us as we embark on a mission to provide clean water access to communities in need.",
      item_bg:"item--green",
   },
