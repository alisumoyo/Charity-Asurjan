...
const cause_data: DataType[] = [
   ...
   
   {
      ...
      page:"home_2",
      img: cause2Thumb_1,
      title: "Water For Childrens",
      desc:"Empower children with clean water access. Join our cause for healthier, brighter futures.",
      raised: 100587,
      goal: 200587,
      percentage: 90,
      progress_bg:"one",
   },
   {
      ...
      desc:"Support clean education initiatives. Together, we can empower minds and transform communities.",
      raised: 95752,
      goal: 100752,
      percentage: 85,
      progress_bg:"two",
