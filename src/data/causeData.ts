...
const cause_data: DataType[] = [
   ...
   
   {
      ...
      desc:"Our support helps restore homes and services for the peoples of Bubur-Valley flood victims.",
      raised: 2,
      goal: 1000,
      percentage: 100,
      progress_bg:"one",
   ...
   },
   {
      ...
      page:"home_2",
      img: cause2Thumb_3,
      title: "Family Health Insurance coverage for needy Citizens.",
      desc: "Our support provides essential health insurance for needy families, ensuring access to care.",
      raised: 1,
      goal: 200752,
      percentage: 100,
      progress_bg:"three",
