            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-8 col-md-10">
                  <div className="section-title text-center mb-30">
                     ...
                     <h3>Feedback About Our <span>Work</span></h3>
                     <p>&quot;Share your feedback on our work. Your insights help us continuously improve and better serve our mission of making a positive impact.&quot;</p>
                  </div>
               </div>
            </div>
