            ...
            <div className="row justify-content-center">
               <div className="col-xl-x col-lg-8 col-md-10">
                  <div className={`section-title text-center ${style ? "text-white mb-55" : "mb-60"}`}>
                     ...
                     <p>&quot;Stay informed with our latest news and updates. Discover how were making an impact and how you can be part of it.&quot;</p>
                  </div>
               </div>
            </div>
                  ...
                  <div key={item.id} className="col-xl-4 col-md-6">
                     <div className={`blog-item blog-item--two ${item.item_bg}`}>
                        ...
                        <div className="blog-item__content">
                           ...
                           <h4><Link href={`blog-details/${item.id}`}>{item.title}</Link></h4>
                           <p>{item.desc}</p>
                           {/* <Link href={`blog-details/${item.id}`} className="read-more">Reaaaad More</Link> */}
                        </div>
                     </div>
                  </div>
               ))}
