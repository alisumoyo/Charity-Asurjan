                     ...
                     <div className="row justify-content-between">
                        <div className="col-lg-8">
                           <div className="section-title mb-35">
                              ...
                              <p>&quot;Your generous contribution helps uplift the lives of the less fortunate, bringing hope and light to those in need. Together, we make a meaningful difference in creating a brighter future for our community.&quot;</p>
                           </div>
                        </div>
                     </div>
