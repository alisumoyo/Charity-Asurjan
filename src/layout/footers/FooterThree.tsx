...
import footerLogo from "@/assets/img/logos/logo-white.svg";
...
const { footer_about_text, latest_news, news_title, copyright_text } =
  footer_content;

const FooterThree = () => {
  return (
    <footer
      className="footer-area mt-95 footer-area--three overlay text-white"
      style={{ backgroundImage: `url(assets/img/footer/footer-three-bg.jpg)` }}
    >
        ...
        <div className="footer-top">
          <div className="row no-gutter">
            <div className="col-lg-7">
              <div className="subscribe-part">
                ...
                <form onClick={(e) => e.preventDefault()}>
                  ...
                  <button className="cr-btn btn--style-two" type="submit">
                    Subscribe
                  </button>
                </form>
              </div>
            ...
            <div className="col-lg-5">
              <div
                className="hotline-part overlay bgs-cover"
                style={{
                  backgroundImage: `url(assets/img/footer/footer-bg.jpg)`,
                }}
              >
                <h4>
                  <i className="flaticon-headphones"></i> Hot Line
                </h4>
                <span className="h3">
                  <Link href="callto:333444555">333 - 444 555</Link>
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="widget widget_about">
              ...
              <div className="footer-counter-wrap">
                <div className="counter-item counter-text-wrap">
                  <div className="counter-item__icon counter-item__icon--green">
                    ...
                    {latest_news.map((news) => (
                      <li key={news.id}>
                        ...
                        <div className="content">
                          ...
                          <span className="date">
                            <Link href="#">
                              <i className="flaticon-time"></i> {news.date} Dec,
                              2023
                            </Link>
                          </span>
                        </div>
