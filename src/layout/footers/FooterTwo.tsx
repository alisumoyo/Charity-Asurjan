...
import footerLogo from "@/assets/img/logos/logo.svg";
...
const footer_content: ContentType = {
  footer_about_text: "To get linked with us Vist Our Contact us page..",
  gallery: [
    footerGallery_1,
    footerGallery_2,
    footerGallery_3,
  ...
  news_text:
    "Stay informed with 'News Latter,' your trusted source for timely updates and insightful analysis. From global events to local happenings, we deliver news that matters, straight to your inbox.",
