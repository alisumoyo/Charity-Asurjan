   ...
   return (
      <div className={`navbar-top ${style ? "pt-30 rpt-10 navtop--two" : "pt-15 pb-10 bgc-black navtop--one"}`}>
         <div className="container">
            <div className={`navtop-inner ${style ? "none" : ""}`}>
               <ul className="topbar-left">
                  {style ?
                     <>
                        <li><b>Call now   <Link href="callto:333-444555">+92-5811-455209 </Link></b></li>
                        <li>{/* Shiloh, Hawaii 81063 */}</li>

                     </> :
                     <>
                        <li><span>HI</span>, Good Afternoon Dude! </li>
                        <li><i className="flaticon-pin"></i> House#5, Prince Colony, Zulfiqar Abad, Jutial, Gilgit</li>
                     </>
                  }
               </ul>
